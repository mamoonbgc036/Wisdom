                ...
                <article class="masonry__brick entry format-audio" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        ...
                        <div class="audio-wrap">
                            <audio id="player" src="<?php echo get_template_directory_uri();?>/assets/media/Yumi_Arai_Vapor_Trail_Hikouki_Gumo.mp3" width="100%" height="42" controls="controls"></audio>
                        </div>
                    </div>
